    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit((v) => mutation.mutate(v))} className="space-y-3">
          <div>
            <label htmlFor="cu-last" className="block text-sm font-medium text-gray-700 mb-1">
              Фамилия
            </label>
            <input
              id="cu-last"
          ...
          <div>
            <label htmlFor="cu-first" className="block text-sm font-medium text-gray-700 mb-1">
              Имя
            </label>
            <input
              id="cu-first"
          ...
          <div>
            <label htmlFor="cu-mid" className="block text-sm font-medium text-gray-700 mb-1">
              Отчество
            </label>
            <input
              id="cu-mid"
          ...
          <div>
            <label htmlFor="cu-pass" className="block text-sm font-medium text-gray-700 mb-1">
              Пароль
            </label>
            <input
              id="cu-pass"
          ...
          <div>
            <label htmlFor="cu-phone" className="block text-sm font-medium text-gray-700 mb-1">
              Телефон
            </label>
            <input
              id="cu-phone"
