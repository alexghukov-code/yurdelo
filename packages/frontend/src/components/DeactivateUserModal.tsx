    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Деактивация <span className="font-medium">{userName}</span>. Активные дела будут переданы
          выбранному адвокату.
        </p>

        <form onSubmit={handleSubmit((v) => mutation.mutate(v))} className="space-y-3">
          <div>
            <label htmlFor="du-date" className="block text-sm font-medium text-gray-700 mb-1">
              Дата
            </label>
            <input
              id="du-date"
          ...
          <div>
            <label htmlFor="du-reason" className="block text-sm font-medium text-gray-700 mb-1">
              Причина
            </label>
            <input
              id="du-reason"
              {...register('reason', { required: 'Причина обязательна.' })}
          ...
          <div>
            <label htmlFor="du-transfer" className="block text-sm font-medium text-gray-700 mb-1">
              Передать дела
            </label>
            <select
              id="du-transfer"
          ...
          <div>
            <label htmlFor="du-comment" className="block text-sm font-medium text-gray-700 mb-1">
              Комментарий
            </label>
            <textarea
              id="du-comment"
